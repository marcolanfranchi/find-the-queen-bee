...
public class RewardGenerator {
    ...
    /**
     * Creates an instance of a RewardGenerator whos GamePanel is the given GamePanel
	...
	int randomY = 0;
        ...
        for (int i = 0; i < maxRegReward; i++) {
			...
			if (randomX == gamePanel.tileM.mapTileNum.length - 1 && randomY == gamePanel.tileM.mapTileNum[0].length - 1) {
				i--;
				continue;
			}
