...
public class Bee extends Entity {
    ...
    /**
     * Creates an instance of a Bee to be held in the given GamePanel and who controls
     * are observed by the given KeyHandler. Sets this Bee's starting X and Y position at
    ...
    /**
     * Sets Bee's image fields to corresponding image, 2 photos used for each direction
     ...
     * rewards in the game, update this Bee's direction, and changes the spriteCounter
     ...
     * of the regular rewards, therefore completing the game. Returns False otherwise.
    ...
    /**
     * Given a Reward, checks if this Bee is currently on the tile containing the Reward.
    ...
    * and it has not collected all of the regular rewards, False otherwise.
    @return a boolean value indicating if this Bee is within 3 tiles of the Queen Bee
    ...
    */
    ...
    /**
     * Checks if the Bee's current Tile locations corresponds to index 3 of the TileManager
     * class which represents the punishment Tile, if the bee is located on this Tile 
